...
<h1>Modifier les plats d'un menu (<?= h($menu->name) ?>)</h1>
    ...
    <div class="input-group">
        <div class="input-group-prepend">
            <?= $this->Form->select('dish_type_filter', $dishtypes, ['onchange' => 'onChange()', 'id' => 'select_type', 'empty' => 'Type de plat', 'class' => 'form-control']) ?>
        </div>
        <?= $this->Form->select('dishes', $dishes, ['id' => 'dishes', 'class' => 'form-control']) ?>
